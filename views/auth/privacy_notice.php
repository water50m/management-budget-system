...
<body class="min-h-screen text-gray-800 relative">
    ...
    <div class="absolute top-6 right-8 bg-white rounded-full shadow-sm px-6 py-2 flex items-center space-x-6 text-sm z-10">
        <button class="text-blue-700 border-b-2 border-blue-700 font-medium pb-1">Thai</button>
        <button class="text-gray-500 hover:text-gray-800 transition pb-1">English</button>
    ...
    <script>
        function toggleSubmitButton() {
            const checkbox = document.getElementById('accept_pdpa');
